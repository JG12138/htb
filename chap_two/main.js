...
const WETLAND_ANIMALS = [
  {
    truth: "美洲河狸",
    desc: `你拍到了一对体型明显较大的动物，身体粗壮，四肢短而有力。

它们的毛色呈深棕色，在湿地边缘的水中缓慢游动。
当其中一只转身时，你清楚看到它那条又宽又扁的尾巴拍打水面。

它们轮流浮出水面换气，又一前一后游向岸边的树枝堆。
其中一只正在用前爪抱着树枝，另一只在旁边停留观察。

你怀疑这是某种水边生活的啮齿类动物。
也许是河狸？也可能是某种外形相近的大型水栖动物。
...
`
  ...
  {
    truth: "普通浣熊",
    desc: `你拍到了一对体型中等的哺乳动物。
它们的身体圆润，四肢灵活，动作看起来非常熟练。
毛色呈灰褐色，尾巴上有明显的深浅相间环状条纹。
脸部有一圈深色的斑纹，看起来像戴着面罩。

其中一只用前爪翻动湿地边缘的石头，另一只低头在水边寻找食物。
它们时不时抬头彼此确认位置。

你怀疑这是某种杂食性的湿地动物。
也许是浣熊？也可能是某种外形相似的小型食肉动物。
...
`
  ...
  {
    truth: "红翅黑鹂",
    desc: `你拍到了一对体型中等的小型鸟类。
它们停在湿地的芦苇和低矮灌木上来回移动。

其中一只全身羽毛呈黑色，翅膀边缘有一块鲜红色与黄色相间的斑块。
另一只颜色更偏褐色，体态略显低调。

它们在同一片芦苇丛中轮流鸣叫，又迅速飞到附近的枝条上。
...
`
  ...
  {
    truth: "林鸳鸯",
    desc: `你拍到了一对体型中等的水鸟在湿地边缘缓慢游动。

其中一只羽毛颜色非常丰富，头部有明显的绿色与紫色光泽，眼睛也是红色的，脸上带有清晰的白色条纹。另一只颜色较为朴素，整体呈灰褐色。

它们像一对情侣鸟，一前一后游过水面，偶尔低头在水中寻找食物。
...
`
  },
  {
    truth: "路易斯安那水鶺鹠",
    desc: `你拍到了一对体型较小的鸟类。
 它们沿着浅水溪流边缘来回行走，而不是直接飞走。

羽毛呈棕色与浅色相间，眼睛上方有一条明显的浅色线条。
尾巴在停下时会轻轻上下摆动。

它们在水边低头寻找昆虫，又迅速跳到附近的石头上。
你怀疑这是某种与水边密切相关的小型鸟类。
...
`
  },
  {
    truth: "长嘴沼泽鹪鹩",
    desc: `你拍到了一对体型很小的鸟类。
它们在芦苇与湿草之间快速穿梭，很少停在开阔地面。
这种鸟类的上半身的羽毛为棕色，腹部和侧面为浅棕色，喉部和胸部为白色。背部为黑色，有白色条纹。眼皮为黑色带有白线，啄短且薄，尾巴短而直立。

两只鸟始终保持在同一片芦苇丛中活动，其中一只叫声十分响亮。
...
`
  ...
  {
    truth: "大白鹭",
    desc: `你拍到了一对体型很大的白色鸟类。
 它们站在浅水中，身体直立，脖子细长呈现出优雅的弯曲形态。

羽毛几乎全为纯白色，在阳光下非常醒目，他们用长而尖的黄色喙对准水面，一动不动地等待猎物。
当其中一只突然低头捕食时，另一只仍保持静止姿态。

和你平时看见的天鹅完全不一样，你怀疑这是一种大型涉水鸟类。
去问问喜欢观鸟的人说不定会有结果？
`
  }
];
...
const FALLS_ANIMALS = [
  {
    truth: "春鸣蛙",
    desc: `你拍到一只喉部鼓起透明鸣囊的小蛙，背部有X形标记。
它停在潮湿灌木枝条上，位置一高一低。你拍到了一对体型极小的蛙类。

其中一只体型比旁边那只略小，喉部的皮肤颜色较深且有些松弛。
你拍到它时，它的喉部正鼓起一个接近透明的半球形鸣囊。它的背部有一个清晰的、深色的“X”型标记。体型稍大的那只腹部看起来比较圆鼓。它的背部同样有“X”型标记，但喉部皮肤平整且颜色较浅

这两只小东西都停在瀑布旁的潮湿灌木枝条上，位置一高一低。
...
`
  },
  {
    truth: "林蛙",
    desc: `你拍到了一对体型较小的蛙类。
其中一只体型较小，前肢非常粗壮。它的背部边缘有两条明显的褶皱线。另一只体型明显更大，身体颜色偏向浅棕色。

它们正穿过瀑布旁的潮湿落叶层，一只紧跟在另一只后方移动。
虽然不知道具体是什么蛙类，但——小心有嘉宾害怕这个。
`
  },
  {
    truth: "斑点蝾螈",
    desc: `在瀑布旁潮湿的岩石缝隙里，你意外抓拍到了两只滑溜溜的小东西。 

这种生物的皮肤是湿润的深黑色，背部有两排亮黄色的圆斑。体型较大的那只背部的黄色斑点也相对较大。
它们正从瀑布边的岩石缝隙中爬出，身体表面覆盖着一层粘液，在阴影中反射光亮。 

这看起来像个带斑点的长尾巴青蛙，但又不太像，可能是蝾螈？
这种黏糊糊的惊喜，不知道你的心动嘉宾会不会喜欢？
`
  },
  {
    truth: "大蓝鹭",
    desc: `在瀑布下游的浅滩，你拍到了一对极其高大的水鸟。

它们有着长长的、像S型弯曲的脖子，全身覆盖着灰蓝色的羽毛。
它像一尊雕塑一样一动不动地站在水里，淡黄色的长喙垂向水面。
另一只则突然对着水面发动袭击，用长喙叼起一条鱼。

你不敢确定这到底是什么鹤还是鹭，这种孤傲的气质倒是挺适合分享给某人的。
以此为话题去问问其他更了解的嘉宾吧？
`
  },
  {
    truth: "卡罗莱纳山雀",
    desc: `你抓拍到了一对小巧玲珑、圆滚滚的鸟。

它们的头顶和喉部是黑色的，脸颊则是显眼的白色，看起来像戴了个黑色的小头盔。
它们在瀑布旁的枝头跳来跳去，一点也不怕人，嘴里还不停地发出“奇卡-地-地”的叫声。 
...
`
  ...
  {
    truth: "美洲知更鸟",
    desc: `你拍到了一对在瀑布旁灌木丛里跳跃的小鸟。

它们有红砖色的胸脯，背部是深灰色的，眼周有细碎的白圈。
它们在湿润的泥土里翻找着什么，偶尔发出一阵清脆的鸣叫。

你怀疑这就是传说中报春的那种鸟，但又不确定。或许这可以作为你们聊天的一个开场白。
`
  }
];
...
const LAKE_ANIMALS = [
  {
    truth: "加拿大雁",
    desc: `你抓拍到了一对体型很大的水鸟。
它们有着标志性的长黑色脖子和头部，脸颊上有一块非常显眼的白色斑纹，背部和翅膀的羽毛主要是棕灰色的。
它们在石头滩上并排走着，步态有些摇晃。
当它们游进水里时，长长的脖子划出优雅的弧线。
你怀疑这是某种大雁，也许可以去问问更了解野生动物的嘉宾？`
  },
  {
    truth: "绿头鸭",
    desc: `你拍到了一对在水面嬉戏的小型鸭子。
其中一只的脖子有一道亮眼的白色条纹，眼睛周围和正脑袋是泛着金属反光的绿色羽毛，在阳光下闪着光。 另一只则显得朴素很多，看起来像是普通的麻纹鸭子。

它们在湖边的浅水区迅速地啄食水草，尾巴尖翘起，侧面有一块明显的白色块。 
...
`
  },
  {
    truth: "赤颈鸭",
    desc: `你拍到了一对在水面嬉戏的小型鸭子。
它们游动的姿态非常轻盈，甚至有点贼头贼脑的。

其中一只头部和颈部是浓郁的棕红色，额头有一块耀眼的金黄色。背部是以灰白色为底，上面全是细如发丝的暗褐色波浪横纹。尾巴则是饱满的黑色。另一只就显得朴素很多。
它们在湖边的浅水区迅速地啄食水草，相伴而游。

这种斑斓的颜色让你怀疑它是某种从谁家后花园溜出来的观赏鸭，或者某种野生的杂交种。
要不拿这张照片去考考你的心动对象？
`
  },
  {
    truth: "白尾鹿",
    desc: `你拍到了一对体型优美的食草动物，正轻手轻脚地在湖边的碎石滩上饮水。

它们身上披着棕红色的短毛。

当你试图靠近时，其中一只突然警觉地竖起了小短尾巴，露出了内侧像雪一样白的毛，像是在发出某种信号，随后它们迅速跃进了附近的树丛。 
...
`
  ...
  {
    truth: "浣熊",
    desc: `你抓拍到了一对在石头缝里鬼鬼祟祟翻找东西的家伙。 
它们有着标志性的黑眼圈，看起来像戴了眼罩的小偷。尾巴长而蓬松，上面有一圈圈黑灰相间的环纹。

最有趣的是，它们竟然像人一样用前爪在湖水里不停地揉搓着什么，动作显得专业又滑稽。 

这就是主持人提醒过要防范的“专业小偷”吧？你得赶紧确认一下自己的背包拉链有没有拉好。
`
  },
  {
    truth: "双冠鸬鹚",
...
它们正站在湖边的枯木上，张开巨大的翅膀一动不动，像是在晾晒一件黑色的雨衣。 
它们的嘴很长，尖端带钩，喉咙处有一小块橙黄色的皮肤。

它们潜入水中时非常安静，再冒头时已经在几十米外了。 
...
`
  ...
  {
    truth: "白腹鱼狗",
    desc: `你拍到了一对头部比例都大得有些夸张的鸟，它正俯冲向湖面，激起一圈波纹。

它的羽毛呈现出一种高级的板岩蓝，头顶有一丛像没梳理好的冠羽，显得乱糟糟的。
胸前有一道宽阔的蓝色横带，腹部则是干净的白色。
它发出的声音像一阵急促的木制响板。 这小家伙捕鱼的架势非常专业，你怀疑它才是这片湖的主人。
